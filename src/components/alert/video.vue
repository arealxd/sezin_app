<template>
  <div class="background" v-if="video">
    <div class="content">
      <div class="inner-content">
        <div class="in-line">
          <p class="block-title">video</p>
        ...
        <iframe class="video-view" :src="video.videoUrl" :title="video.title" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p class="content-text">{{video.description}}</p>
      </div>
    </div>
  </div>
</template>
